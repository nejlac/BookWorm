...
{
    public class DeclinedBookState : BaseBookState
    {
        public DeclinedBookState(IServiceProvider serviceProvider, BookWormDbContext context, IMapper mapper) : base(serviceProvider, context, mapper)
        {
        }
        ...
        public override async Task<BookResponse> UpdateAsync(int id, BookCreateUpdateRequest request)
        {
            ...
            // Restore the original CreatedByUserId
