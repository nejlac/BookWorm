...
{
    public class SubmittedAuthorState : BaseAuthorState
    {
        public SubmittedAuthorState(IServiceProvider serviceProvider, BookWormDbContext context, IMapper mapper) : base(serviceProvider, context, mapper) { }
