...
namespace BookWormWebAPI.Controllers
{
    ...
    {
        new Book { Title = "1984", AuthorId = GetAuthorId("George Orwell"), Description = "Dystopian novel.", PublicationYear = 1949, PageCount = 328, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "Animal Farm", AuthorId = GetAuthorId("George Orwell"), Description = "Political allegory.", PublicationYear = 1945, PageCount = 112, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "Harry Potter and the Sorcerer's Stone", AuthorId = GetAuthorId("J.K. Rowling"), Description = "First in Harry Potter series.", PublicationYear = 1997, PageCount = 309, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "Harry Potter and the Chamber of Secrets", AuthorId = GetAuthorId("J.K. Rowling"), Description = "Second in Harry Potter series.", PublicationYear = 1998, PageCount = 341, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "The Hobbit", AuthorId = GetAuthorId("J.R.R. Tolkien"), Description = "Fantasy adventure.", PublicationYear = 1937, PageCount = 310, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "The Fellowship of the Ring", AuthorId = GetAuthorId("J.R.R. Tolkien"), Description = "First part of LOTR.", PublicationYear = 1954, PageCount = 423, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "Pride and Prejudice", AuthorId = GetAuthorId("Jane Austen"), Description = "Romantic novel.", PublicationYear = 1813, PageCount = 279, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "Emma", AuthorId = GetAuthorId("Jane Austen"), Description = "Another novel by Austen.", PublicationYear = 1815, PageCount = 474, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "Adventures of Huckleberry Finn", AuthorId = GetAuthorId("Mark Twain"), Description = "Classic American novel.", PublicationYear = 1884, PageCount = 366, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "The Adventures of Tom Sawyer", AuthorId = GetAuthorId("Mark Twain"), Description = "Another classic.", PublicationYear = 1876, PageCount = 274, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "The Great Gatsby", AuthorId = GetAuthorId("F. Scott Fitzgerald"), Description = "A story of the Jazz Age.", PublicationYear = 1925, PageCount = 180, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "To Kill a Mockingbird", AuthorId = GetAuthorId("Harper Lee"), Description = "Classic of modern American literature.", PublicationYear = 1960, PageCount = 281, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "Frankenstein", AuthorId = GetAuthorId("Mary Shelley"), Description = "Gothic novel.", PublicationYear = 1818, PageCount = 280, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "Murder on the Orient Express", AuthorId = GetAuthorId("Agatha Christie"), Description = "Hercule Poirot mystery.", PublicationYear = 1934, PageCount = 256, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "A Tale of Two Cities", AuthorId = GetAuthorId("Charles Dickens"), Description = "Historical novel.", PublicationYear = 1859, PageCount = 489, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "Love in the Time of Cholera", AuthorId = GetAuthorId("Gabriel García Márquez"), Description = "Romantic novel.", PublicationYear = 1985, PageCount = 348, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "The Trial", AuthorId = GetAuthorId("Franz Kafka"), Description = "Existential novel.", PublicationYear = 1925, PageCount = 255, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "Crime and Punishment", AuthorId = GetAuthorId("Fyodor Dostoevsky"), Description = "Psychological novel.", PublicationYear = 1866, PageCount = 671, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "War and Peace", AuthorId = GetAuthorId("Leo Tolstoy"), Description = "Epic historical novel.", PublicationYear = 1869, PageCount = 1225, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId },
        new Book { Title = "The Old Man and the Sea", AuthorId = GetAuthorId("Ernest Hemingway"), Description = "Short novel about struggle.", PublicationYear = 1952, PageCount = 127, CoverImageUrl = new byte[] {}, CreatedAt = now, UpdatedAt = now, BookState = "Accepted", CreatedByUserId = adminUserId }
    };
