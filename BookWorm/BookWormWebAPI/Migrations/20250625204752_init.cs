        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModdifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverImageUrl = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfBooksRead = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadingChallenges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReadingChallenges_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadingChallengeBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReadingChallengeBooks_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ReadingChallengeBooks_ReadingChallenges_ReadingChallengeId",
                        column: x => x.ReadingChallengeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingChallengeBooks_BookId",
                table: "ReadingChallengeBooks",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_ReadingChallengeBooks_ReadingChallengeId_BookId",
                table: "ReadingChallengeBooks",
                columns: new[] { "ReadingChallengeId", "BookId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingListBooks_ReadingListId_BookId",
                table: "ReadingListBooks",
