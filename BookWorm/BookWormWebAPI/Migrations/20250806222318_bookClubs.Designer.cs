...
namespace BookWormWebAPI.Migrations
{
    ...
    [Migration("20250806222318_bookClubs")]
    partial class bookClubs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookWorm.Services.DataBase.BookClub", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookWorm.Services.DataBase.BookClubEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BookClubEvents");
                });

            modelBuilder.Entity("BookWorm.Services.DataBase.BookClubEventParticipant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("BookClubEventId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BookClubEventId");

                    b.HasIndex("UserId", "BookClubEventId")
                        .IsUnique();

                    b.ToTable("BookClubEventParticipants");
                });

            modelBuilder.Entity("BookWorm.Services.DataBase.BookClubMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookWorm.Services.DataBase.Quote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookWorm.Services.DataBase.ReadingStreak", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookWorm.Services.DataBase.BookClub", b =>
                {
                    b.HasOne("BookWorm.Services.DataBase.User", "ClubCreator")
                        .WithMany()
            ...
            modelBuilder.Entity("BookWorm.Services.DataBase.BookClubEvent", b =>
                {
                    b.HasOne("BookWorm.Services.DataBase.BookClub", "BookClub")
                        .WithMany("Events")
                    ...
                    b.HasOne("BookWorm.Services.DataBase.User", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("BookWorm.Services.DataBase.BookClubEventParticipant", b =>
                {
                    b.HasOne("BookWorm.Services.DataBase.BookClubEvent", "BookClubEvent")
                        .WithMany("Participants")
                        .HasForeignKey("BookClubEventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookWorm.Services.DataBase.User", "User")
                        .WithMany("BookClubEventParticipants")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BookClubEvent");
            ...
            modelBuilder.Entity("BookWorm.Services.DataBase.User", b =>
                {
                    b.Navigation("BookClubEventParticipants");
